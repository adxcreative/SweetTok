...
from utils.train_generator_utils import (
    get_config, create_model_and_loss_module, get_sweet_tokenizer,
...
def main():
    ...
    logger = setup_logger(name="SweetTok-Gen", log_level="INFO",
    ...
    model, ema_model, loss_module = create_model_and_loss_module(
        config, logger, accelerator, model_type="transformer")
