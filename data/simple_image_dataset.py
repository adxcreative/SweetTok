...
from .video_dataset import ImageDataset
...
class SimpleImageDataset:
    def __init__(
        ...
        self._train_dataset = ImageDataset(train_shards_path, None, -1, 17, 
        ...
        self._eval_dataset = ImageDataset(train_shards_path, None, -1, 17, 
